...
const returnAssertionSet = (req, res) => {
  try {
    ...
    const normalisedBeliefSet = (0, deCheemInternalUtils_1.normaliseBeliefSet)(
      beliefSet
    );
    console.log(JSON.stringify(normalisedBeliefSet));
    const assertionSet = (0, deCheemInternalUtils_1.generateAssertions)(
      normalisedBeliefSet
    );
...
const exploreBeliefSet = (req, res) => {
  try {
    ...
    const exploreResults = (0, deCheemExploreUtils_1.exploreAssertions)(
      explore,
      assertionSet
    );
